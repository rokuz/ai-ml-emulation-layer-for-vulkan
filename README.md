...
with the weights of up to four output channel groups, and every invocation then
convolves from shared memory only. The kernel is used when a tile fits into
